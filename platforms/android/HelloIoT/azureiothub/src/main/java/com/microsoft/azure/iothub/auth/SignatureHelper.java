...
public final class SignatureHelper
{
    ...
    public static byte[] decodeDeviceKeyBase64(String deviceKey)
    {
        ...
        try {
            //return org.apache.commons.codec.binary.Hex.decodeHex(deviceKey.toCharArray());
            // return org.apache.commons.codec.binary.Base64.decodeBase64(deviceKey.getBytes());
            return Base64.decode(deviceKey, 16);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static byte[] encodeSignatureBase64(byte[] sig)
    {
        ...
        // return android.util.Base64.encode(sig, 16);
