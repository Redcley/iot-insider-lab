//Forked from https://github.com/todotani/BME280_Test
...
namespace Sensor.BME280
{
    ...
    public class BME280: IBarometer, ITemperature, IHumidity
    {
        ...
        private string I2CControllerName = "I2C1";
        ...
        public BME280(string i2cBusName)
        {
            ...
            this.t_sb = (byte)standbySettings_e.tsb_0p5ms;
            this.mode = (byte)mode_e.smNormal;
            this.filter = (byte)filterCoefficient_e.fc_16;
            this.osrs_p = (byte)oversampling_e.os16x;
            this.osrs_t = (byte)oversampling_e.os2x;
        ...
        private ushort ReadUInt16_LittleEndian(byte register)
        {
            ...
            i2c.WriteRead(writeBuffer, readBuffer);
