...
namespace ArgonneWebApi.Controllers
{
    ...
    public class CampaignController : Controller
    {
        ...
        /// <response code="404">Not Found</response>
        /// <response code="400">Invalid Id</response>
        [Route("api/admin/[controller]/{campaignid}/impressions/aggregate", Name = "GetAggregateImpressionsForCampaign")]
        [HttpGet]
            ...
            [FromQuery]DateTime? end = null)
        {
            ...
            var result = await queryContext.Query<AdAggregateData>("GetCampaignAdAggregateData @campaignId,@adId,@dateFrom,@dateTo", campaignIdParam, adIdParam,
                startDateParam, endDateParam).ConfigureAwait(false);
            return new OkObjectResult(result);
        }
        ...
        /// <response code="404">Not Found</response>
        /// <response code="400">Invalid Id</response>
        [Route("api/admin/[controller]/{campaignid}/impressions/aggregatebyad", Name = "GetAggregateImpressionsForCampaignByAd")]
        [HttpGet]
            ...
            [FromQuery]DateTime? end = null)
        {
            ...
            var result = await queryContext.Query<CampaignAdAggregateData>("GetCampaignAdAggregates @campaignId,@dateFrom,@dateTo", campaignIdParam,
                startDateParam, endDateParam).ConfigureAwait(false);
            return new OkObjectResult(result);
        }
