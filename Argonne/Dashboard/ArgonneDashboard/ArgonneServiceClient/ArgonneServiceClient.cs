...
namespace ArgonneService
{
    public partial class ArgonneServiceClient : ServiceClient<ArgonneServiceClient>, IArgonneServiceClient
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> ApiAdminCampaignByCampaignidEmotionsStrongestGetWithOperationResponseAsync(string campaignid, int? pageNumber = null, int? pageSize = null, DateTimeOffset? start = null, DateTimeOffset? end = null, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (campaignid == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "ApiAdminCampaignByCampaignidEmotionsStrongestGetAsync", tracingParameters);
            }
            ...
            if (end != null)
            {
                queryParameters.Add("end=" + Uri.EscapeDataString(end.Value.ToString()));
            }
            if (queryParameters.Count > 0)
            {
                url = url + "?" + string.Join("&", queryParameters);
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<AdAggregateData>>> ApiAdminCampaignByCampaignidImpressionsAggregateGetWithOperationResponseAsync(string campaignid, int? pageNumber = null, int? pageSize = null, DateTimeOffset? start = null, DateTimeOffset? end = null, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (campaignid == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("start", start);
                tracingParameters.Add("end", end);
                ServiceClientTracing.Enter(invocationId, this, "ApiAdminCampaignByCampaignidImpressionsAggregateGetAsync", tracingParameters);
            }
            ...
            // Create Result
            HttpOperationResponse<IList<AdAggregateData>> result = new HttpOperationResponse<IList<AdAggregateData>>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            ...
            if (statusCode == HttpStatusCode.OK)
            {
                IList<AdAggregateData> resultModel = new List<AdAggregateData>();
                JToken responseDoc = null;
                if (string.IsNullOrEmpty(responseContent) == false)
                {
                    responseDoc = JToken.Parse(responseContent);
                ...
                if (responseDoc != null)
                {
                    resultModel = AdAggregateDataCollection.DeserializeJson(responseDoc);
                }
                result.Body = resultModel;
            }
