...
namespace ArgonneService
{
    public partial interface IArgonneServiceClient : IDisposable
    {
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<string>> ApiAdminCampaignByCampaignidEmotionsStrongestGetWithOperationResponseAsync(string campaignid, int? pageNumber = null, int? pageSize = null, DateTimeOffset? start = null, DateTimeOffset? end = null, CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<IList<AdAggregateData>>> ApiAdminCampaignByCampaignidImpressionsAggregateGetWithOperationResponseAsync(string campaignid, int? pageNumber = null, int? pageSize = null, DateTimeOffset? start = null, DateTimeOffset? end = null, CancellationToken cancellationToken = default(System.Threading.CancellationToken));
