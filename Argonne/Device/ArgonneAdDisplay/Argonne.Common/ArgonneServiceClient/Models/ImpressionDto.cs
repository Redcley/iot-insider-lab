...
namespace Argonne.Common.ArgonneService.Models
{
    public partial class ImpressionDto
    {
        ...
        /// </summary>
        /// <returns>
        /// Returns the json model for the type ImpressionDto
        /// </returns>
        public virtual JToken SerializeJson(JToken outputObject)
        {
            ...
            {
                outputObject["deviceTimestamp"] = this.DeviceTimestamp.Value;
            }
            if (this.DisplayedAdId != null)
            {
                outputObject["displayedAdId"] = this.DisplayedAdId;
            }
            if (this.ImpressionId != null)
            {
                outputObject["impressionId"] = this.ImpressionId.Value;
            }
            if (this.InsertTimestamp != null)
            {
                outputObject["insertTimestamp"] = this.InsertTimestamp.Value;
            }
            if (this.MessageId != null)
            {
                outputObject["messageId"] = this.MessageId;
            }
            return outputObject;
        }
    }
